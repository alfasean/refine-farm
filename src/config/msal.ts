...
export const msalConfig: Configuration = {
  auth: {
    clientId: "dc2fa1d1-20c1-4f4b-bc34-353e14c2b3c1",
    authority:
      "https://login.microsoftonline.com/fa8e6530-e738-4a3d-9a2b-345926eed2a9",
...
export const loginRequest = {
  scopes: ["api://43ef9a6b-a30b-404c-b804-4598b856a2fb/token"],
};
